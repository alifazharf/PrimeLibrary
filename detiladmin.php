...
<?php 
	$selected = $_GET['edit'];
	$query = "select * from admin where id_admin='$selected";
...
<div class='col-sm-4'>
	<div class='well' class='slideOutUp'>
		...
		<form role='form' action='updateadmin.php' method='post'>

		  <div class='form-group'>
		    <label for='id'>Id Admin</label>
		    <input class="form-control" type="text" name="id_admin" placeholder="Nama" autocomplete="off" value="<?php echo $admin['id_admin']; ?>" readonly>
		  </div>
